...
public class RemoveGemmeCommand implements CommandExecutor {
    private ChaosGems plugin;
    private File playerData, messages;
    public RemoveGemmeCommand(ChaosGems plugin, File playerData, File messages){
        this.plugin=plugin;
    ...
    public boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        if(command.getName().equalsIgnoreCase("removegemme")){
            ...
            if(sender instanceof Player){
                ...
                if(args.length!=2){
                    String message = messagesConfig.getString("errori.removegemme.missing-args");
                    ...
                    String message=messagesConfig.getString("messaggi.removegemme.sottratte");
